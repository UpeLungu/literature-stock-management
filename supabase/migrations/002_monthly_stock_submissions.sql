-- Monthly literature stock counts and submissions.
...
-- Temporary MVP policies for the publishable key. Replace with authenticated
-- congregation/user policies when login and roles are enabled.
